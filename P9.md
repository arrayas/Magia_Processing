...
puedes ver en la figura [1](#fig:ps9_1){reference-type="ref"
reference="fig:ps9_1"}.

![Círculos usando variables.](pictures/ps9_1.png){#fig:ps9_1
width="60%"}
...
figura [2](#fig:ps9_2){reference-type="ref" reference="fig:ps9_2"}.

![Círculos usando variables.](pictures/ps9_2.png){#fig:ps9_2
width="60%"}
...
figura [3](#fig:ps9_3){reference-type="ref" reference="fig:ps9_3"}.

![Círculos usando variables.](pictures/ps9_3.png){#fig:ps9_3
width="60%"}
