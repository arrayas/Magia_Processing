...
se dice ``integer'' por eso la abreviatura {\tt int}. 
...
como {\tt float} para números con decimales. Viene de la palabra inglesa 
...
teclado la definiremos con {\tt char} que viene de ``character'' en 
